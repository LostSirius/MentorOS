...
export async function GET() {
  const envKeyMap: Record<string, VALID_ENV_KEYS> = {
    ...
    "supervisor-skills": VALID_ENV_KEYS.SUPERVISOR_SKILLS_API_KEY,
  ...
  return createResponse(
    {
      ...
      configured: {
        ...
        anthropicProxy: Boolean(process.env.ANTHROPIC_BASE_URL),
        openaiProxy: Boolean(process.env.OPENAI_API_BASE)
      }
    },
    200
  )
