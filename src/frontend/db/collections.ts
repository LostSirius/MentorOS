...
export const getCollectionWorkspacesByWorkspaceId = async (
  ...
  return workspace as typeof workspace & { collections: Tables<"collections">[] }
}
...
export const getCollectionWorkspacesByCollectionId = async (
  ...
  return collection as typeof collection & { workspaces: Tables<"workspaces">[] }
}
...
export const createCollections = async (
  ...
  await createCollectionWorkspaces(
    createdCollections.map((collection: Tables<"collections">) => ({
