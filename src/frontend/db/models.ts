...
export const getModelWorkspacesByWorkspaceId = async (workspaceId: string) => {
  ...
  return workspace as typeof workspace & { models: Tables<"models">[] }
}
...
export const getModelWorkspacesByModelId = async (modelId: string) => {
  ...
  return model as typeof model & { workspaces: Tables<"workspaces">[] }
}
...
export const createModels = async (
  ...
  await createModelWorkspaces(
    createdModels.map((model: Tables<"models">) => ({
      user_id: model.user_id,
      model_id: model.id,
      workspace_id
    }))
