...
export const getAssistantWorkspacesByWorkspaceId = async (
  ...
  return workspace as typeof workspace & { assistants: Tables<"assistants">[] }
}
...
export const getAssistantWorkspacesByAssistantId = async (
  ...
  return assistant as typeof assistant & { workspaces: Tables<"workspaces">[] }
}
...
export const createAssistants = async (
  ...
  await createAssistantWorkspaces(
    createdAssistants.map((assistant: Tables<"assistants">) => ({
